...
5. Performing the `help` command to open the window will not allow you to open the command history while the help window is currently open. The remedy is to simply either close the help window, or click on Notarius (the Main window) before continuing to use the application.
...
| **Sort**            | Format: `sort PREFIX` <br> <br> Example: `sort n/`                                                                                                                                                                                                                                |
