...
#### Planned:
Include in the user preferences new settings that allow the user to adjust their scroll speed, and the number of
commands to show in the command history in the same window.
